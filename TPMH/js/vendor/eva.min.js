...
*/
  ...
  \****************************************************/
        ...
        function(a, t, e) {
            ...
            ,
            function() {
                return void 0 === r && (r = h.apply(this, arguments)),
                r
            }
            ), i = (d = {},
            function(a) {
                ...
                for (var e = 0; e < a.length; e++) {
                    ...
                    if (r) {
                        ...
                        for (; d < h.parts.length; d++)
                            r.parts.push(L(h.parts[d], t))
                    } else {
                        var i = [];
                        for (d = 0; d < h.parts.length; d++)
                            i.push(L(h.parts[d], t));
                        n[h.id] = {
                            id: h.id,
                            refs: 1,
                            parts: i
            ...
            function y(a, t) {
                for (var e = [], h = {}, r = 0; r < a.length; r++) {
                    var d = a[r]
                      , i = t.base ? d[0] + t.base : d[0]
                      , g = {
                        css: d[1],
                        media: d[2],
                        sourceMap: d[3]
                    };
                    h[i] ? h[i].parts.push(g) : e.push(h[i] = {
                        id: i,
                        parts: [g]
                    })
                }
            ...
            function z(a, t) {
                ...
                var h = g[g.length - 1];
                if ("top" === a.insertAt)
                    h ? h.nextSibling ? e.insertBefore(t, h.nextSibling) : e.appendChild(t) : e.insertBefore(t, e.firstChild),
                    g.push(t);
            ...
            function L(t, a) {
                ...
                if (a.singleton) {
                    ...
                    r = t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = a,
                    ...
                    h = function(a, t, e) {
                        var h = e.css
                          , r = e.sourceMap
                          , d = void 0 === t.convertToAbsoluteUrls && r;
            ...
            a.exports = function(a, i) {
                ...
                i.singleton || "boolean" == typeof i.singleton || (i.singleton = o()),
            ...
            function A(a, t, e, h) {
                var r = e ? "" : h.css;
                if (a.styleSheet)
                    a.styleSheet.cssText = u(t, r);
                else {
                    var d = document.createTextNode(r)
                      , i = a.childNodes;
                    i[t] && a.removeChild(i[t]),
                    i.length ? a.insertBefore(d, i[t]) : a.appendChild(d)
                }
            }
        },
        "./node_modules/style-loader/lib/urls.js": /*!***********************************************!*\
        ...
        function(a, t) {
            a.exports = function(a) {
                ...
                return a.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(a, t) {
                    ...
                    return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(h) ? a : (e = 0 === h.indexOf("//") ? h : 0 === h.indexOf("/") ? r + h : d + h.replace(/^\.\//, ""),
  ...
  \************************************/
        ...
        function(a, t, e) {
            ...
            "./node_modules/style-loader/lib/addStyles.js")(h, r);
                ...
                (t = [{
                    ...
                    value: function() {
                        var t, a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, e = a.animation, h = o(a, ["animation"]), r = function(a) {
                            ...
                            t
                        }(e), d = r ? r.class : "", i = l({}, this.attrs, h, {
                ...
                Array.from(a).forEach(function(a) {
                    return function(a) {
                        ...
                        Array.from(h.attributes).reduce(function(a, t) {
                            var e;
                            return v[t.name] ? a.animation = m({}, a.animation, y({}, v[t.name], t.value)) : a = m({}, a, M[(e = t).name] ? y({}, M[e.name], e.value) : y({}, e.name, e.value)),
                            a
                        }, {})), i = d.name, g = z(d, ["name"]), n = p.default[i].toSvg(m({}, r, g, {
                            animation: (t = r.animation,
                            e = g.animation,
                            t || e ? m({}, t, e) : null)
                        }, {
                            class: c()(r.class, g.class)
